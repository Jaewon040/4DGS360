...
class BaseDataset(Dataset):
    ...
    def is_val_fgonly(self) -> bool:
        """Whether to render only foreground gaussians during validation"""
        return getattr(self, 'val_fgonly', False)

    def is_val_fgonly_bgwhite(self) -> bool:
        """Whether to render background gaussians as white during validation"""
        return getattr(self, 'val_fgonly_bgwhite', False)
